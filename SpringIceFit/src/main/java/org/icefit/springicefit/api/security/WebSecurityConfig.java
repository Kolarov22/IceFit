    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        ...
        http.authorizeHttpRequests()
                .requestMatchers("/","/auth/v1/register","/auth/v1/login","/auth/v2/registerClient","/auth/v2/registerInstructor"
                        ,"/auth/v2/login","/auth/v2/registerAdmin","v1/training/","v1/training/create","v1/training/plans", "v1/support/","v1/support/create","v1/update/","v1/update/client").permitAll()
